...
import customMenuLink from '../../utils/customMenuLinks';
...
function Index() {
    ...
    const items = (
        <Menu>
            <Menu.SubMenu key="1" title="Branch Location">
                <Menu.Item key="2-1-1" style={{ color: theme === 'light' ? '#000' : '#fff' }}>Gurgaon</Menu.Item>
                <Menu.Item key="2-1-2" style={{ color: theme === 'light' ? '#000' : '#fff' }}>Lajpat Nagar</Menu.Item>
                <Menu.Item key="2-1-3" style={{ color: theme === 'light' ? '#000' : '#fff' }}>Noida</Menu.Item>
            </Menu.SubMenu>
            <Menu.Item key="2" style={{ color: theme === 'light' ? '#000' : '#fff' }}>
                Financial Year
            </Menu.Item>
        </Menu>
    );
        ...
        >
            <div className={styles.headerLeft}>
                {/* <div className={styles.userAvatar}>
                    <Avatar
                        className={styles.userAvatarInside}
                ...
                <div className={styles.userText}>
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', gap: '0.7rem', color: '#FF3E5B' }}>
                        Goregoan (W) Mumbai
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16"
                            height="14" width="14" xmlns="http://www.w3.org/2000/svg"><path
                                fillRule="evenodd"
                        ...
                        <Dropdown
                            ...
                            style={{
                                boxShadow: theme === 'light' ?
                                    ...
                                    :
                                    '0 6px 16px 0 rgba(255,255,255,0.8), 0 3px 6px -4px rgba(255,255,255,0.9), 0 9px 28px 8px rgba(255,255,255,0.9)',
                            }}
                        >
                ...
                <Space size={22} wrap>
                    ...
                    <div className={styles.userProfile}>
                        ...
                        <div className={styles.userDetails}>
                            {/* user name */}
                            <span className={styles.username}>Nilesh Rathod</span>
                            <p>
                                <span className={styles.userNumber}>0123456789</span>
                                <span>
                                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 20 20" aria-hidden="true" height="16" width="16"
                                        xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd"
                                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                </span>
                            </p>
                        </div>
                    </div>
